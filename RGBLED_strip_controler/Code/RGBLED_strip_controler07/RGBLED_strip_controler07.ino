...
void loop() {
  ...
  */
  ...
  if (mode == 7) {
    analogWrite(houseLights[0][0], 0);
    analogWrite(houseLights[0][1], 0);
    analogWrite(houseLights[0][2], 0);
    analogWrite(houseLights[0][3], 0);
    analogWrite(pins[0][0], 255);
    analogWrite(pins[0][1], 255);
    analogWrite(pins[0][2], 255);
    analogWrite(pins[0][3], 255);
    analogWrite(houseLights[0][3], 100);
    delay(400);
    analogWrite(houseLights[0][3], 0);
    delay(400);
    analogWrite(houseLights[0][3], 100);
  ...
  if (mode == 6) {
    ...
    //3,5,6 are house lights. all on makes all off
    analogWrite(11, 0);
    analogWrite(3, 0);
    speedStrip();
    delay(ssdelay);
